...
class GeneticAgent(Agent):
    ...
    def create_chromosomes(self, use_one_point_crossover: bool):
        chromosomes = []
    ...
    def get_fittest_chromosome(self, chromosomes: list[list[int]]):
        highest_reward = 0
    ...
    def mutate_chromosome(self, chromosome: list[int]):
    ...
    def uniform_crossover(self, chromosome1: list[int], chromosome2: list[int]):
    ...
    def one_point_crossover(self, chromosome1: list[int], chromosome2: list[int]):
    ...
    def tournament_selection(self, sample_size: int, use_one_point_crossover: bool):
        new_chromosomes = []
